...
/**
 * Contains static methods for managing the temporary workspace and project used by the application
 * 
 */
public abstract class TempWsUtils {
	 ...
	 *                            uri
	 */
	public static void copyAndCompress(String workspacePath, String simplifiedSctunitPath, String sourceFilePath,
